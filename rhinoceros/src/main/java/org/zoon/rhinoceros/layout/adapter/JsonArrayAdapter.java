package org.zoon.rhinoceros.layout.adapter;
...
//    private JsChannel js;
    ...
    protected void onToolsClone(HView<? extends View> hView) {
        ...
        setLayoutInflater(new HLayoutInflater(hView.getLayoutInflater()).setDimens(hDimens));
    }
    ...
    public JsonArrayAdapter setLayoutInflater(HLayoutInflater layoutInflater) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            try {
                hView = layoutInflater.parse(layoutString);
